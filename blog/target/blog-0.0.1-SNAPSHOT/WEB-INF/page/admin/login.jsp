...
<style>
	.login-bg{width: 100%;min-height: 650px;height: calc(100vh - 100px - 100px);background-image: url("${pageContext.request.contextPath}/static/img/background.jpg");background-size: cover;background-position: 55% center;background-repeat: no-repeat;position: relative;}
...
<body>
	...
	<div style="width: 100%;height: 100px;text-align: center;line-height: 100px;">
		ssm博客系统 版权所有 ©2018 赣ICP备18000415号
	</div>
</body>
