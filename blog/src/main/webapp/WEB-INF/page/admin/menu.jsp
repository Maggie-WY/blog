...
<div id="menu" class="menu" style="width: 260px;">
	...
	<ul>
		...
		<li class="menu-item">
			...
			<ul>
				<li><a href="${pageContext.request.contextPath}/article_info/articleList.action"><span>文章列表</span></a></li>
				<li><a href="${pageContext.request.contextPath}/article_info/recycleList.action"><span>回收站</span></a></li>
			</ul>
		</li>
	</ul>
</div>
