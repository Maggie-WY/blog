...
<div id="nav">
	...
	<div id="search" class="hide">
		<span class="search-field-wrapper form-group">
			<input type="text" class="search" placeholder="搜索…" value="" name="" onkeydown="if(event.keyCode==13){search(this.value);}">
		</span>
	...
	$(function() {
		$.ajax({
			...
			success : function(rtn) {
				var typeList = rtn.date.typeList;
				var html = '';
